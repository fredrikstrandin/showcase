...
namespace RelationManager.DataAccess
{
    public class Neo4jDataAccess : INeo4jDataAccess
    {
        ...
        /// </summary>
        public Neo4jDataAccess(IDriver driver, ILogger<Neo4jDataAccess> logger, IOptions<Neo4jSetting> neo4jSettingsOptions)
        {
            _logger = logger;
            _database = neo4jSettingsOptions.Value.Database;
